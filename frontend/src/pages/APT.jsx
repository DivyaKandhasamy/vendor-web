...
export default function APT() {
  ...
  useEffect(() => {
    ...
    async function fetchAptImageUrl() {
      try {
        const response = await axios.get('http://localhost:5000/params/APT_OF_THE_MONTH_IMAGE');
    ...
    <>
      <div className="relative threat-actor-card bg-gray-100">
        ...
        <div className='card-cta-section'>
          <a href="/threat-actor-of-the-month" className="cta-link">
            <div className="card">
              <img className='card-image' src={aptOfTheMonthImage} />
            </div>
          </a>
        </div>
      </div>

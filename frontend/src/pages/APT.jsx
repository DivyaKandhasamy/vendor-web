                    ...
                    <tr key={gridData[index].id}>
                      {gridData[index] && (
                        <td className="whitespace-nowrap text-center py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                          <a className='font-semibold link-text' href='#'>{gridData[index].name}</a>
                        </td>
                      )}
                      {gridData[index + 1] && (
                        <td className="whitespace-nowrap text-center py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                          <a className='font-semibold link-text' href='#'>{gridData[index + 1].name}</a>
                        </td>
                      )}
                      {gridData[index + 2] && (
                        <td className="whitespace-nowrap text-center py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                          <a className='font-semibold link-text' href='#'>{gridData[index + 2].name}</a>
                        </td>
                      )}
                    </tr>
                  );

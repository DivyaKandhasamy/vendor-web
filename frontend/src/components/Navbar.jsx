...
const Navbar = () => {
  ...
  return (
    <div className='bg-gray-100 pe-10 md:pe-0 flex justify-between items-center h-24 mx-auto text-gray-900'>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r z-10 border-r-gray-900 text-gray-100 bg-[#000300] ease-in-out duration-500' : 'ease-in-out fixed left-0 z-10 top-0 h-full duration-500 h-f fixed left-[-100%]'}>
